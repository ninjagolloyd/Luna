	...
	<fieldset class="postfield">
        ...
        <div class="richeditor">
			<div class="btn-toolbar textarea-toolbar textarea-top">
				...
				<div class="btn-group">
					<a class="btn btn-danger btn-editor disabled" href="javascript:void(0);" onclick="AddTag('inline','b');" title="<?php _e('Bold', 'luna'); ?>" tabindex="-1"><span class="fa fa-fw fa-bold fa-fw"></span></a>
					<a class="btn btn-danger btn-editor disabled" href="javascript:void(0);" onclick="AddTag('inline','u');" title="<?php _e('Underline', 'luna'); ?>" tabindex="-1"><span class="fa fa-fw fa-underline fa-fw"></span></a>
					<a class="btn btn-danger btn-editor disabled hidden-sm hidden-xs" href="javascript:void(0);" onclick="AddTag('inline','i');" title="<?php _e('Italics', 'luna'); ?>" tabindex="-1"><span class="fa fa-fw fa-italic fa-fw"></span></a>
					<a class="btn btn-danger btn-editor disabled hidden-sm hidden-xs" href="javascript:void(0);" onclick="AddTag('inline','s');" title="<?php _e('Strike', 'luna'); ?>" tabindex="-1"><span class="fa fa-fw fa-strikethrough fa-fw"></span></a>
				</div>
				<div class="btn-group">
				...
				<div class="btn-group">
					<a class="btn btn-danger btn-editor disabled" href="javascript:void(0);" onclick="AddTag('inline','quote');" title="<?php _e('Quote', 'luna'); ?>" tabindex="-1"><span class="fa fa-fw fa-quote-left fa-fw"></span></a>
				...
				<div class="btn-group">
					<a class="btn btn-danger btn-editor disabled" href="javascript:void(0);" onclick="AddTag('inline','url');" title="<?php _e('URL', 'luna'); ?>" tabindex="-1"><span class="fa fa-fw fa-link fa-fw"></span></a>
					<a class="btn btn-danger btn-editor disabled" href="javascript:void(0);" onclick="AddTag('inline','img');" title="<?php _e('Image', 'luna'); ?>" tabindex="-1"><span class="fa fa-fw fa-image fa-fw"></span></a>
				...
				<div class="btn-group">
					<a class="btn btn-danger btn-editor disabled" href="javascript:void(0);" onclick="AddTag('list', 'list');" title="<?php _e('List', 'luna'); ?>" tabindex="-1"><span class="fa fa-fw fa-list-ul fa-fw"></span></a>
					<a class="btn btn-danger btn-editor disabled" href="javascript:void(0);" onclick="AddTag('inline','*');" title="<?php _e('List item', 'luna'); ?>" tabindex="-1"><span class="fa fa-fw fa-asterisk fa-fw"></span></a>
				</div>
				<div class="btn-group">
...
<?php } ?>
			...
			<div class="btn-toolbar textarea-toolbar textarea-top">
				...
				<?php echo $silence_btn ?>
				<div class="btn-group">
					<button class="btn btn-default btn-editor" title="<?php _e('Bold', 'luna'); ?>" onclick="wswgEditor.doClick('bold');" type="button"><span class="fa fa-fw fa-bold fa-fw"></span></button>
					<button class="btn btn-default btn-editor" title="<?php _e('Underline', 'luna'); ?>" onclick="wswgEditor.doClick('underline');" type="button"><span class="fa fa-fw fa-underline fa-fw"></span></button>
					<button class="btn btn-default btn-editor" title="<?php _e('Italic', 'luna'); ?>" onclick="wswgEditor.doClick('italic');" type="button"><span class="fa fa-fw fa-italic fa-fw"></span></button>
					<button class="btn btn-default btn-editor" title="<?php _e('Strike', 'luna'); ?>" onclick="wswgEditor.doClick('strikethrough');" type="button"><span class="fa fa-fw fa-strikethrough fa-fw"></span></button>
				</div>
				<div class="btn-group">
					<button class="btn btn-default btn-editor" title="<?php _e('Heading', 'luna'); ?>" onclick="wswgEditor.doClick('heading');" type="button"><span class="fa fa-fw fa-header fa-fw"></span></button>
					<button class="btn btn-default btn-editor" title="<?php _e('Subscript', 'luna'); ?>" onclick="wswgEditor.doClick('sub');" type="button"><span class="fa fa-fw fa-subscript fa-fw"></span></button>
					<button class="btn btn-default btn-editor" title="<?php _e('Superscript', 'luna'); ?>" onclick="wswgEditor.doClick('sup');" type="button"><span class="fa fa-fw fa-superscript fa-fw"></span></button>
				</div>
				<div class="btn-group">
					<button class="btn btn-default btn-editor" title="<?php _e('Quote', 'luna'); ?>" onclick="wswgEditor.doQuote();" type="button"><span class="fa fa-fw fa-quote-left fa-fw"></span></button>
					<button class="btn btn-default btn-editor" title="<?php _e('Code', 'luna'); ?>" onclick="wswgEditor.doClick('code');" type="button"><span class="fa fa-fw fa-code fa-fw"></span></button>
					<a class="btn btn-default btn-editor hidden-md hidden-sm hidden-xs" href="javascript:void(0);" onclick="AddTag('inline','c');" title="<?php _e('Inline code', 'luna'); ?>" tabindex="-1"><span class="fa fa-fw fa-file-code-o fa-fw"></span></a>
				</div>
				<div class="btn-group">
					<button class="btn btn-default btn-editor" title="<?php _e('URL', 'luna'); ?>" onclick="wswgEditor.doLink();" type="button"><span class="fa fa-fw fa-link fa-fw"></span></button>
					<button class="btn btn-default btn-editor" title="<?php _e('Image', 'luna'); ?>" onclick="wswgEditor.doImage();" type="button"><span class="fa fa-fw fa-image fa-fw"></span></button>
					<button class="btn btn-default btn-editor" title="<?php _e('Video', 'luna'); ?>" onclick="wswgEditor.InsertYoutube();" type="button"><span class="fa fa-fw fa-play-circle fa-fw"></span></button>
				</div>
				<div class="btn-group">
					<button class="btn btn-default btn-editor" title="<?php _e('List', 'luna'); ?>" onclick="wswgEditor.doClick('InsertUnorderedList');" type="button"><span class="fa fa-fw fa-list fa-fw"></span></button>
				</div>
				<div class="btn-group">
<?php if ($luna_config['o_emoji'] == 1) { ?>
					<a class="btn btn-default btn-editor btn-emoji dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
...
<?php } ?>
			...
			<div class="btn-toolbar textarea-toolbar textarea-bottom">
				<div class="btn-group pull-right">
					<button class="btn btn-with-text btn-default" onclick="wswgEditor.doCheck();" type="submit" name="preview" accesskey="p" tabindex="<?php echo $cur_index++ ?>"><span class="fa fa-fw fa-eye"></span> <?php _e('Preview', 'luna') ?></button>
					<button class="btn btn-with-text btn-primary" onclick="wswgEditor.doCheck();" type="submit" name="submit" accesskey="s" tabindex="<?php echo $cur_index++ ?>"><span class="fa fa-fw fa-plus"></span> <?php _e('Submit', 'luna') ?></button>
				</div>
			</div>
