	...
	<fieldset class="postfield">
        ...
        <div class="richeditor">
			<div class="btn-toolbar textarea-toolbar textarea-top">
				...
				<div class="btn-group">
					<a class="btn btn-danger btn-editor disabled" href="javascript:void(0);" onclick="AddTag('inline','b');" title="<?php echo $lang['Bold']; ?>" tabindex="-1"><span class="fa fa-fw fa-bold fa-fw"></span></a>
					<a class="btn btn-danger btn-editor disabled" href="javascript:void(0);" onclick="AddTag('inline','u');" title="<?php echo $lang['Underline']; ?>" tabindex="-1"><span class="fa fa-fw fa-underline fa-fw"></span></a>
					<a class="btn btn-danger btn-editor disabled hidden-sm hidden-xs" href="javascript:void(0);" onclick="AddTag('inline','i');" title="<?php echo $lang['Italic']; ?>" tabindex="-1"><span class="fa fa-fw fa-italic fa-fw"></span></a>
					<a class="btn btn-danger btn-editor disabled hidden-sm hidden-xs" href="javascript:void(0);" onclick="AddTag('inline','s');" title="<?php echo $lang['Strike']; ?>" tabindex="-1"><span class="fa fa-fw fa-strikethrough fa-fw"></span></a>
				</div>
				<div class="btn-group">
				...
				<div class="btn-group">
					<a class="btn btn-danger btn-editor disabled" href="javascript:void(0);" onclick="AddTag('inline','quote');" title="<?php echo $lang['Quote']; ?>" tabindex="-1"><span class="fa fa-fw fa-quote-left fa-fw"></span></a>
				...
				<div class="btn-group">
					<a class="btn btn-danger btn-editor disabled" href="javascript:void(0);" onclick="AddTag('inline','url');" title="<?php echo $lang['URL']; ?>" tabindex="-1"><span class="fa fa-fw fa-link fa-fw"></span></a>
					<a class="btn btn-danger btn-editor disabled" href="javascript:void(0);" onclick="AddTag('inline','img');" title="<?php echo $lang['Image']; ?>" tabindex="-1"><span class="fa fa-fw fa-image fa-fw"></span></a>
				...
				<div class="btn-group">
					<a class="btn btn-danger btn-editor disabled" href="javascript:void(0);" onclick="AddTag('list', 'list');" title="<?php echo $lang['List']; ?>" tabindex="-1"><span class="fa fa-fw fa-list-ul fa-fw"></span></a>
					<a class="btn btn-danger btn-editor disabled" href="javascript:void(0);" onclick="AddTag('inline','*');" title="<?php echo $lang['List item']; ?>" tabindex="-1"><span class="fa fa-fw fa-asterisk fa-fw"></span></a>
				</div>
				<div class="btn-group">
...
<?php } ?>
			...
			<div class="btn-toolbar textarea-toolbar textarea-top">
				...
				<?php echo $silence_btn ?>
				<div class="btn-group">
					<button class="btn btn-default btn-editor" title="<?php echo $lang['Bold']; ?>" onclick="wswgEditor.doClick('bold');" type="button"><span class="fa fa-fw fa-bold fa-fw"></span></button>
					<button class="btn btn-default btn-editor" title="<?php echo $lang['Underline']; ?>" onclick="wswgEditor.doClick('underline');" type="button"><span class="fa fa-fw fa-underline fa-fw"></span></button>
					<button class="btn btn-default btn-editor" title="<?php echo $lang['Italic']; ?>" onclick="wswgEditor.doClick('italic');" type="button"><span class="fa fa-fw fa-italic fa-fw"></span></button>
				...
				<div class="btn-group">
					<button class="btn btn-default btn-editor" title="<?php echo $lang['Quote']; ?>" onclick="wswgEditor.doQuote();" type="button"><span class="fa fa-fw fa-quote-left fa-fw"></span></button>
					<button class="btn btn-default btn-editor" title="<?php echo $lang['Code']; ?>" onclick="wswgEditor.doClick('code');" type="button"><span class="fa fa-fw fa-code fa-fw"></span></button>
					<a class="btn btn-default btn-editor hidden-md hidden-sm hidden-xs" href="javascript:void(0);" onclick="AddTag('inline','c');" title="<?php echo $lang['Inline code']; ?>" tabindex="-1"><span class="fa fa-fw fa-file-code-o fa-fw"></span></a>
				</div>
				<div class="btn-group">
